...
////    }
//
//    public static Pair<EagerArrayDataset<Float>, EagerArrayDataset<Float>> eagerDataset2D(EagerSession session) throws IOException, NoSuchAlgorithmException {
//        // Download MNIST files if they don't exist.
//        MNIST.download();
//
//        // Read data files into arrays
...
//        // Return a pair of graph loaders; train and test sets
//        return new Pair<>(
//                new EagerArrayDataset<>(
//                        session, Constant.create(tf.scope(), trainImages), Constant.create(tf.scope(), trainLabels)),
//                new EagerArrayDataset<>(
//                        session, Constant.create(tf.scope(), testImages), Constant.create(tf.scope(), testLabels)));
//    }
//
//    /**
